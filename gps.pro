...
UBUNTU_TRANSLATION_DOMAIN="gps.liu-xiao-guo"
...
aptest.commands = bash $$PWD/gps/tests/autopilot/run
aptest.depends  = sub-gps

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/gps/tests/unit 
unittest.depends  = sub-gps
